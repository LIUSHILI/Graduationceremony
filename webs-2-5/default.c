...
void websSetDefaultPage(char_t *page)
{
	...
	#ifdef DEBUG
		printf("websDefaultPage is :%s\n",websDefaultPage);	//Modify by :LuiShiLi
	#endif													//Date		:2001.09.29
}
...
void websSetDefaultDir(char_t *dir)
{
	...
	#ifdef DEBUG
		printf("websDefaultDir is :%d\n",websDefaultDir);	//Modify by :LuiShiLi
	#endif													//Date		:2001.09.28
