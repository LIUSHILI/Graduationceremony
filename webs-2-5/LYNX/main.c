...
//Changed By LiuShiLi 2011.09.28
...
int main(int argc, char **argv)
{
	...
	//use :command -demo to use dirtory wwwdemo for web : Modify by LuiShiLi 2011.09.28
	for (i = 1; i < argc; i++) 
	{
	...
	//首先分配一个大的内存块（60*1024字节），
	//以后只要是以b开头的对内存操作的函数都
	//是在这个已经分好的内存块上的操作，这些操作在Balloc.c中实现。	
